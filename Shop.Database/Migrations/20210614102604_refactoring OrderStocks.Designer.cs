...
namespace Shop.Database.Migrations
{
    ...
    [Migration("20210614102604_refactoring OrderStocks")]
    partial class refactoringOrderStocks
    {
            ...
            modelBuilder.Entity("Shop.Domain.Models.OrderStock", b =>
                {
                    ...
                    b.Property<int?>("OrderStockOrderId")
                        .HasColumnType("integer");

                    b.Property<int?>("OrderStockStockId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("OrderStockStockId", "OrderStockOrderId");
            ...
            modelBuilder.Entity("Shop.Domain.Models.OrderStock", b =>
                {
                    ...
                    b.HasOne("Shop.Domain.Models.OrderStock", null)
                        .WithMany("OrderStocks")
                        .HasForeignKey("OrderStockStockId", "OrderStockOrderId");
